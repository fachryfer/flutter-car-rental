...
class _EditCarScreenState extends State<EditCarScreen> {
  ...
  void initState() {
    ...
    _descriptionController = TextEditingController(text: widget.carData['description']);
    _priceController = TextEditingController(text: widget.carData['price'].toString());
    _quantityController = TextEditingController(text: widget.carData['quantity'].toString());
    _currentImageUrl = widget.carData['imageUrl'];
  }
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Gagal memperbarui mobil: $e'), backgroundColor: Colors.red),
        );
      }
    } finally {
      if (mounted) {
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  if (int.tryParse(value) == null) {
                    return 'Jumlah unit harus berupa angka';
                  }
                  return null;
                },
              ),
